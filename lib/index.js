...
var Cubemap = /** @class */ (function () {
    ...
    Cubemap.prototype.load = function () {
        ...
        var stripIndices = (_b = {},
            ...
            _b[Directions.FRONT] = 1,
            _b[Directions.RIGHT] = 2,
            _b[Directions.BACK] = 3,
            _b[Directions.BOTTOM] = 4,
            _b[Directions.TOP] = 5,
            _b);
        var isSingleImage = typeof this.images === 'string';
        var singleImageUrl = isSingleImage ? this.images : null;
        var _loop_1 = function (face) {
            var url = isSingleImage ? singleImageUrl : this_1.images[face];
            ...
            if (isSingleImage) {
                ...
                var percentageShift = (stripIndices[face] / 5) * 100;
                img.style.objectPosition = "".concat(percentageShift, "% 0%");
            }
            img.onload = function () {
